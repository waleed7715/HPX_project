...
bulk_flag      = pd.read_csv("using_bulk_async_nostack_flag.csv")
bulk_numcores  = pd.read_csv("using_bulk_async_nostack_num_cores.csv")
...
for size in SIZES:
    ...
    ax.plot(
        ...
        linewidth=2,
        markersize=7,
        label="bulk_async_nostack_num_cores"
    )
