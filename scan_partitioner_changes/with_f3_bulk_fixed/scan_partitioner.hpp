                ...
                try
                {
                    ...
                    if (workitems.size() == 2)
                    {
                        ...
                        finalitems.push_back(
                            execution::async_execute(stackless_policy.executor(),
                                f3, first_, count_ - count, workitems[0]));

                        workitems[1] = HPX_INVOKE(f2, workitems[0], workitems[1]);
                    }
                    else
                    {
                    ...
                    // {
                    //     auto curr = execution::async_execute(stackless_policy.executor(),
                    //         f1, hpx::get<0>(elem), hpx::get<1>(elem))
                    //                     .share();
                    ...
                    //     static hpx::util::itt::string_handle h("F1_WAIT");
                    ...
                    // F3 return type is void
                    {
                        ...
                        finalitems.push_back(
                            hpx::parallel::execution::bulk_async_execute(
                                stackless_policy.executor(),
                                [f3, &workitems, shape](std::size_t idx) {
                                    auto f3_local = f3;
                                    auto it = std::next(
                                        hpx::util::begin(shape), idx);
                                    HPX_INVOKE(f3_local, hpx::get<0>(*it),
                                        hpx::get<1>(*it), workitems[idx]);
                                },
                                hpx::util::counting_shape<std::size_t>(
                                    size)));
                    }
